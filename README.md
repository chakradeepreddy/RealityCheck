...
**RealityCheck** is an AI-assisted browser verification system that turns website claims into controlled, replayable experiments and determines whether they are actually true.
...
**K. Chakradeep · K. Abhinash**

Built during **Hack Summit 7.0 — SRM KTR**.

> **Built with curiosity. Tested with reality.** 🚀
